...
//  Notes
//
//  Created by Andrew Vladislavlev on 21.05.17.
//  Copyright © 2017 Andrew Vladislavlev. All rights reserved.
//

#import <Foundation/Foundation.h>

static NSString *const Url = @"https://bnet.i-partner.ru/testAPI/";
static NSString *const Token = @"DgKJaDg-AB-kajVZPM";
static NSString *const DisplayedDateFormat = @"dd MMMM yyyy HH:mm";
